...
const Navbar=()=>{
    ...
    const {products,filteredData,setFilteredData,cart}=useContext(AppContext)
        ...
        <>
        {
            userRole && (
                ...
                <div className="nav_bar ">
                    ...
                    <Link to={"/userproductlist"} className="left" style={{textDecoration:"none",color:"white"}}>
                        <h3>GadgetPulse</h3>
                    </Link>
...
search
                   ...
                   <div className="sub_bar">
                    ...
                    {navrole === "Admin" && (
                        ...
                        <Link to={"/allproduct"} className="left" style={{textDecoration:"none",color:"white"}}>
                            <h3>GadgetPulse</h3>
                        </Link>
                        <form className="search_bar" onSubmit={submitHandler}>
                        <span className="material-symbols-outlined">
search
                        ...
                        <div className="right">
                            ...
                            <Link to={"/addproduct"} className="btn btn-success mx-3">Add Product</Link>
                            <Link to={"/allexpense"} className="btn btn-light mx-3">Expense Details</Link>

                            <Link to={"/allproduct"} className="btn btn-info mx-3">Product List</Link>
                            <Link to={"/allorders"} className="btn btn-light mx-3">Order Details</Link>
                            <Link to={"/profile"} className="btn btn-warning mx-3">Profile</Link>
