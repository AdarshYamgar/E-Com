...
const RegisterDemo=()=>{ 
    ...
    return(
        <>
         <div className="container vh-75 d-flex justify-content-center align-items-center mt-5  ">
      ...
      <div className="row min-vh-50  border rounded  border-dark shadow mx-auto"  style={{ width: "100%", maxWidth: "800px",maxHeight:"600px" }}>
        ...
        <div className="col-lg-6 d-flex flex-column align-items-center justify-content-center">
          <div className="">
            <h2 className="mt-3 mb-4 fs-1 fw-bold text-center d-flex">Create Account</h2>
    ...
    <option value="Admin">Admin</option>
        ...
        <div className="col-lg-6 d-flex flex-column align-items-center justify-content-center  text-center text-light " style={{backgroundColor:"#de453a"}}>
          ...
          <Link to="/" class="btn" style={{backgroundColor: "#de453a", color: "white", width: "50%" ,border:"2px solid white",borderRadius:"40px"}}>Sign In</Link>
