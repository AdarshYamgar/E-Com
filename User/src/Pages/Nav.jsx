 ...
 const hideLink=(localtion.pathname === "/profile" || localtion.pathname === "/usedata") || localtion.pathname === "/cart";
  ...
  return (
    <Navbar bg="dark" variant="dark" expand="lg" className=" bg-body-dark py-4 nav sticky-top">
      <Container fluid>
        <Navbar.Brand as={Link} to="/" className='ml-5' style={{fontSize:"30px"}}>GadgetPulse</Navbar.Brand>
        ...
        <Navbar.Collapse id="navbarScroll">
          ...
          >
            ...
            <Nav.Link as={Link} to="/usedata" className='fs-5 me-3'>Order History</Nav.Link>
